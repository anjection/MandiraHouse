...
const EVENT_IMAGES = [
    '/MandiraHouse/images/events/event-1.jpg',
    '/MandiraHouse/images/events/event-2.jpg',
    '/MandiraHouse/images/events/event-3.jpg',
];
...
export default function EventSlider({ onPauseChange, onNameChange }: { onPauseChange?: (isPaused: boolean) => void; onNameChange?: (name: string) => void }) {
    ...
    const paginate = useCallback((newDirection: number) => {
        ...
        setCurrentIndex((prevIndex) => {
            ...
            if (nextIndex < 0) nextIndex = EVENT_IMAGES.length - 1;
            if (nextIndex >= EVENT_IMAGES.length) nextIndex = 0;
            return nextIndex;
        });
    }, []);
    ...
    useEffect(() => {
        if (onNameChange) {
            onNameChange(getImageName(EVENT_IMAGES[currentIndex]));
        }
